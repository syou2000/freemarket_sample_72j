$(function(){
  ...
  function appendChidrenBox(insertHTML){
    ...
    childSelectHtml = `<div class='exhibitionPage__main__contents__detail__category__choose__added' id= 'children_wrapper'>
                        <div class='exhibitionPage__main__contents__detail__category__choose'>
    ...
    $('.exhibitionPage__main__contents__detail__category__title').append(childSelectHtml);
  }
  ...
  function appendGrandchidrenBox(insertHTML){
    ...
    grandchildSelectHtml = `<div class='exhibitionPage__main__contents__detail__category__choose__added' id= 'grandchildren_wrapper'>
                              <div class='exhibitionPage__main__contents__detail__category__choose'>
                                ...
                                <i class='fas fa-chevron-down exhibitionPage__main__contents__detail__category__choose__box--arrow-down'></i>
                              </div>
                            </div>`;
    $('.exhibitionPage__main__contents__detail__category').append(grandchildSelectHtml);
  }
  ...
  // 子カテゴリー選択後のイベント
  $('.exhibitionPage__main__contents__detail__category__title').on('change', '#child_category', function(){
